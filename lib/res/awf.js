...
if (typeof document != 'undefined' && typeof window != 'undefined') {
    ...
    if ($$$AWF$$$.legacyBrowser) {
        var extern = $$$AWF$$$.extern;
        extern.push({url:'//cdn.bootcss.com/es5-shim/4.4.0/es5-shim.min.js'});
        extern.push({url:'//cdn.bootcss.com/es5-shim/4.4.0/es5-sham.min.js'});
        extern.push({url:'//cdn.bootcss.com/json3/3.3.2/json3.min.js'});
    }
