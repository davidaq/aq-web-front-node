 var $$$AWF$$$ = (function(window, document) {
    ...
    var AWF = {
        ...
        lib : {},
        use : {},
        define : function(modName, modFunc, immediate, basename, relativePath) {
            var mod = {};
            mod.body = modFunc;
            mod.name = modName;
            mod.exports = {};
            ...
            if (basename != '.')
                ...
                basename = '';
            mod.src = function(src) {
                if (src.substr(0, 1) == '/')
                    return basename + src.substr(1);
                if (src.substr(0, 2) == './') 
                    return basename + relativePath + '/' + src.substr(2);
                if (src.substr(0, 3) == '../') {
                    ...
                    return basename + rel.concat(src).join('/');
                }
                return src;
            };
            if (immediate) {
        ...
        require : function(modName) {
            ...
            throw new Error("module not ready or doesn't exist");
        },
        signal : function() {},
