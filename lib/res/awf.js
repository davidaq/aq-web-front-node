...
$$$AWF$$$.XMLHttpRequest = (function() {
    ...
    function Request() {
        if (superClass) {
            superClass.appply(this, arguments);
        } else {
            var xhr;
    ...
    if (typeof XMLHttpRequest !== 'undefined') {
        $$$AWF$$$.common._inherits(Request, XMLHttpRequest);
        superClass = XMLHttpRequest;
    }
    Request.prototype.onResult = function() {};
    ...
    Request.post = invoker('get');
    Request.put = invoker('get');
    Request.delete = invoker('get');
})();
$$$AWF$$$.common = {};
