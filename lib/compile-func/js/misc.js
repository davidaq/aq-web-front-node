...
function misc(babel) {
    ...
    function updateSignal(target, expression) {
        if (target.type == 'MemberExpression' && !target.object.antiLoop) {
            ...
            this.replaceWith(types.CallExpression({
    ...
    visitor.AssignmentExpression = function(path) {
    ...
    visitor.UpdateExpression = function(path) {
    ...
    visitor.UnaryExpression = function(path) {
