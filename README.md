...
You'll be able to use these popular libraries in your project just by one line of import.
How these libraries are actually loaded depends on configuration.

You are allowed to add other external libraries by editing the library section of the 
configuration file.
