(function() {
var DEBUG=true;
var $$$AWF$$$=function(window,document){"use strict";var es6helpers={_temporalAssertDefined:function(val,name,undef){if(val===undef){throw new ReferenceError(name+" is not defined - temporal dead zone")}return true},_inherits:function(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass)}if(AWF.legacyBrowser){var proto=superClass.prototype;subClass.prototype={};if(proto){for(var k in proto){subClass.prototype[k]=proto[k]}}subClass.AWFsuperClass=superClass}else{subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass){Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass}}},_instanceof:function(left,right){if(AWF.legacyBrowser){if(left instanceof right)return true;left=left.AWFClassType;while(left){if(left==right){return true}left=left.AWFsuperClass}return false}else{if(right!=null&&right[Symbol.hasInstance]){return right[Symbol.hasInstance](left)}else{return left instanceof right}}},_classCallCheck:function(instance,Constructor){if(!AWF.legacyBrowser&&!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function")}if(!instance.AWFClassType){instance.AWFClassType=Constructor}},_interopRequireDefault:function(obj){return obj&&obj.__esModule?obj:{"default":obj}},_possibleConstructorReturn:function(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called")}return call&&(typeof call==="object"||typeof call==="function")?call:self},_newArrowCheck:function(innerThis,boundThis){if(innerThis!==boundThis){throw new TypeError("Cannot instantiate an arrow function")}},_boundProp:function(context,item){if(typeof item=="function"){return item.bind(context)}return item}};if(!window||!document){return es6helpers}var AWF={};AWF.es6=es6helpers;AWF.mod={};AWF.queue=[];AWF.extern=[];AWF.lib={};AWF.use={};AWF.define=function(modName,modFunc,immediate){var mod={};mod.body=modFunc;mod.name=modName;mod.exports={};AWF.mod[modName]=mod;if(immediate){mod.body.call(mod,mod,mod.exports,AWF.require)}else{AWF.queue.push(mod)}};AWF.require=function(modName){if(modName=="react"&&AWF.mod["React"])modName="React";var mod=AWF.mod[modName]||{};if(mod.exports){if(!mod.imported&&typeof mod.exports.__beforeFirstImport=="function"){mod.exports.__beforeFirstImport()}mod.imported=true;return mod.exports}return{}};function BEGIN(){if(!AWF.legacyBrowser){AWF.use["es5-shim"]=0;AWF.use["es5-sham"]=0;AWF.use["json3"]=0}var loc=document.location;if(!document.head){document.head=document.getElementsByTagName("head")[0]}if(!document.body){document.body=document.getElementsByTagName("body")[0]}var extern=AWF.extern;next();function next(){var item=extern.shift();if(!item)return ready();loadScript(item.url,next,item.exports)}function ready(){setTimeout(function(){var queue=AWF.queue;for(var i=0;i<queue.length;i++){var mod=queue[i];mod.body.call(mod,mod,mod.exports,AWF.require)}AWF.queue=null},2)}}AWF.legacyBrowser=!!function(){if(typeof navigator=="undefined")return false;if(/MSIE (\d+\.\d+);/.test(navigator.userAgent)){var ieversion=new Number(RegExp.$1);return ieversion<=8}return false}();var dummy=function(){};if(typeof console=="undefined"){window.console={assert:dummy,clear:dummy,count:dummy,debug:dummy,dir:dummy,dirxml:dummy,error:dummy,group:dummy,groupCollapsed:dummy,groupEnd:dummy,info:dummy,log:dummy,profile:dummy,profileEnd:dummy,table:dummy,time:dummy,timeEnd:dummy,timeStamp:dummy,trace:dummy,warn:dummy}}else if(!DEBUG){for(var k in console){if(k!="error"&&typeof console[k]=="function"){console[k]=dummy}}}setTimeout(function contentLoaded(fn){var done=false,top=true,win=window,doc=win.document,root=doc.documentElement,modern=doc.addEventListener,add=modern?"addEventListener":"attachEvent",rem=modern?"removeEventListener":"detachEvent",pre=modern?"":"on",init=function(e){if(e.type=="readystatechange"&&doc.readyState!="complete")return;(e.type=="load"?win:doc)[rem](pre+e.type,init,false);if(!done&&(done=true))fn.call(win,e.type||e)},poll=function(){try{root.doScroll("left")}catch(e){setTimeout(poll,50);return}init("poll")};if(doc.readyState=="complete")fn.call(win,"lazy");else{if(!modern&&root.doScroll){try{top=!win.frameElement}catch(e){}if(top)poll()}doc[add](pre+"DOMContentLoaded",init,false);doc[add](pre+"readystatechange",init,false);win[add](pre+"load",init,false)}}.bind(0,BEGIN),2);var loadScript=function(){var loading=window.AWFloadingScript=window.AWFloadingScript||{};function loadScript(url,callback,checkVar){if(checkVar&&window[checkVar])return callback();var queue=loading[url];if(!queue){queue=loading[url]={cb:[],ele:null,uncache:function(){delete loading[url];if(this.ele.parentNode)this.ele.parentNode.removeChild(this.ele)},arg:null};setTimeout(load,2)}if(typeof callback=="function"){if(queue.cb){queue.cb.push(callback)}else{callback(queue.arg,queue)}}function load(){var loader=document.createElement("script");queue.ele=loader;loader.type="text/javascript";loader.onload=end;loader.onreadystatechange=function(){if(loader.readyState=="loaded"||loader.readyState=="complete"){setTimeout(end,5)}};var ended=false;function end(){if(ended)return;ended=true;var arg=checkVar?window[checkVar]:null;for(var i=0;i<queue.cb.length;i++){queue.cb[i](arg,queue)}queue.arg=arg;queue.cb=null}loader.src=url;document.head.appendChild(loader)}}return loadScript}();return AWF}(typeof window!="undefined"?window:null,typeof document!="undefined"?document:null);if(typeof module=="object"&&module.exports)module.exports=$$$AWF$$$;
...
if(!exports.$$$AWF$$$Extended){exports.prototype.follow=function(emitter,evtName){evtName=evtName||"update";var list=this.$$$AWF$$$Private$EventEmitter=this.$$$AWF$$$Private$EventEmitter||[];var self=this;var emitName=evtName;var func=function(){var args=[emitName].concat(arguments);return self.emit.apply(self,args)};list.push([emitter,evtName,func]);emitter.on(evtName,func);return{as:as};function as(evtName){emitName=evtName}};exports.prototype.unfollow=function(emitter,evtName){evtName=evtName||"update";var list=this.$$$AWF$$$Private$EventEmitter;if(!list)return;for(var i=0;i<list.length;i++){var item=list[i];if(item[0]==emitter&&item[1]==evtName){emitter.off(evtName,item[2])}}};exports.$$$AWF$$$Extended=true}
}, true);
$$$AWF$$$.define("UIComponent",function(module,exports,require){module.exports=UIComponent;var React=require("React");$$$AWF$$$.es6._inherits(UIComponent,React.Component);function UIComponent(){React.Component.call(this);if(!this.state)this.state={};var priv=this.$$$AWF$$$Private$$$UIComponent={};priv.follows=[];priv.mounting=false;var willMount=this.componentWillMount;if(typeof willMount=="function"){this.componentWillMount=function(){priv.mounting=true;willMount.apply(this,arguments);priv.mounting=false}}var willUnmount=this.componentWillUnmount;if(typeof willUnmount!="function"){willUnmount=false}this.componentWillUnmount=function(){for(var i=0;i<priv.follows.length;i++){var item=priv.follows[i];if(typeof item.emitter.off=="function"){item.emitter.off(item.evt,item.handler)}}if(willUnmount){willUnmount.apply(this,arguments)}}}UIComponent.prototype.follow=function(emitter,evt){if(!this.$$$AWF$$$Private$$$UIComponent.mounting){throw new Error("`follow` may only be called in `componentWillMount` method")}if(!emitter)throw new Error("Followed event emitter may not be empty");evt=evt||"update";if(emitter instanceof Array){for(var i=0;i<emitter.length;i++){this.follow(emitter[i],evt)}}else if(typeof emitter.on=="function"){var self=this;var priv=this.$$$AWF$$$Private$$$UIComponent;var item={emitter:emitter,evt:evt,handler:function(){self.forceUpdate()}};priv.follows.push(item);emitter.on(evt,item.handler);item.handler()}};UIComponent.prototype.bindState=function(name){var self=this;return function(e){var state={};state[name]=e.target.value;self.setState(state)}}});
$$$AWF$$$.define("React", function(module, exports, require) {
 /**
  * React v0.14.3
  */
...
exports = module.exports;
exports.createElement=function(createElement){if(createElement.$$$AWF$$$extended)return createElement;var ret=function(){var options=arguments[1];if(options&&typeof options=="object"){if(typeof options["if"]!="undefined"){var condition=options["if"];if(typeof condition=="function"){condition=condition()}if(!condition){return null}}if(Array.isArray(options.className)){options.className=options.className.join(" ")}}return createElement.apply(React,arguments)};ret.$$$AWF$$$extended=true;return ret}(exports.createElement);
}, true);
var React=$$$AWF$$$.require("React");
$$$AWF$$$.define("ReactDOM", function(module, exports, require) {
/**
 * ReactDOM v0.14.3
 *
 * Copyright 2013-2015, Facebook, Inc.
...
var ReactDOM=$$$AWF$$$.require("ReactDOM");
$$$AWF$$$.lib["es5-shim"]={"url":"https://cdnjs.cloudflare.com/ajax/libs/es5-shim/4.4.1/es5-shim.min.js"};
$$$AWF$$$.define("es5-shim", function(module, exports, require) {
}, true);
$$$AWF$$$.define("es5-sham", function(module, exports, require) {
/*!
...
$$$AWF$$$.lib["json3"]={"url":"https://cdnjs.cloudflare.com/ajax/libs/json3/3.3.2/json3.min.js","exports":"JSON"};
$$$AWF$$$.define("json3", function(module, exports, require) {
module.exports = exports = window["JSON"];
}, true);
$$$AWF$$$.define("GroceryList/ListItem/Model", function(module, exports, require) {
'use strict';var _interopRequireDefault=$$$AWF$$$.es6._interopRequireDefault;var _classCallCheck=$$$AWF$$$.es6._classCallCheck;var _possibleConstructorReturn=$$$AWF$$$.es6._possibleConstructorReturn;var _inherits=$$$AWF$$$.es6._inherits;var _EventEmitter2=require('EventEmitter');var _EventEmitter3=_interopRequireDefault(_EventEmitter2);var counter=0;var Model=(function(_EventEmitter){_inherits(Model,_EventEmitter);function Model(parent,text){var crossed=arguments.length <= 2 || arguments[2] === undefined?false:arguments[2];_classCallCheck(this,Model);var _this=_possibleConstructorReturn(this,_EventEmitter.call(this));_this.id = counter++;_this.parent = parent;_this.text = text;_this.crossed = crossed;return _this;}Model.prototype.cross = (function(){function cross(){this.crossed = true;this.emit('update');}return cross;})();Model.prototype.remove = (function(){function remove(){this.parent.removeItem(this);}return remove;})();Model.prototype.toJSON = (function(){function toJSON(){return {text:this.text,crossed:this.crossed};}return toJSON;})();return Model;})(_EventEmitter3['default']);exports['default'] = Model;module.exports = Model;
});
$$$AWF$$$.define("GroceryList/ListItem/View", function(module, exports, require) {
'use strict';var _interopRequireDefault=$$$AWF$$$.es6._interopRequireDefault;var _classCallCheck=$$$AWF$$$.es6._classCallCheck;var _possibleConstructorReturn=$$$AWF$$$.es6._possibleConstructorReturn;var _inherits=$$$AWF$$$.es6._inherits;exports.__esModule = true;var _UIComponent2=require('UIComponent');var _UIComponent3=_interopRequireDefault(_UIComponent2);var ViewJSX=(function(_UIComponent){_inherits(ViewJSX,_UIComponent);function ViewJSX(){_classCallCheck(this,ViewJSX);return _possibleConstructorReturn(this,_UIComponent.apply(this,arguments));}ViewJSX.prototype.render = (function(){function render(){return React.createElement('div',{className:["item",this.model.crossed?'crossed':'']},this.model.text,React.createElement('div',{className:'cross','if':!this.model.crossed,onClick:$$$AWF$$$.es6._boundProp(this.model,this.model.cross)}),React.createElement('div',{className:'remove','if':$$$AWF$$$.es6._boundProp(this.model,this.model.crossed),onClick:$$$AWF$$$.es6._boundProp(this.model,this.model.remove)}));}return render;})();return ViewJSX;})(_UIComponent3['default']);exports['default'] = ViewJSX;
});
$$$AWF$$$.define("GroceryList/ListItem/Component", function(module, exports, require) {
'use strict';var _interopRequireDefault=$$$AWF$$$.es6._interopRequireDefault;var _classCallCheck=$$$AWF$$$.es6._classCallCheck;var _possibleConstructorReturn=$$$AWF$$$.es6._possibleConstructorReturn;var _inherits=$$$AWF$$$.es6._inherits;var _View2=require('GroceryList/ListItem/View');var _View3=_interopRequireDefault(_View2);var Component=(function(_View){_inherits(Component,_View);function Component(){_classCallCheck(this,Component);return _possibleConstructorReturn(this,_View.apply(this,arguments));}Component.prototype.componentWillMount = (function(){function componentWillMount(){this.model = this.props.model;this.follow(this.model);}return componentWillMount;})();return Component;})(_View3['default']);exports['default'] = Component;module.exports = Component;
});
$$$AWF$$$.define("GroceryList/ListItem", function(module, exports, require) {
'use strict';var _interopRequireDefault=$$$AWF$$$.es6._interopRequireDefault;exports.__esModule = true;var _Component=require('GroceryList/ListItem/Component');var _Component2=_interopRequireDefault(_Component);exports['default'] = _Component2['default'];
});
$$$AWF$$$.define("GroceryList/Model", function(module, exports, require) {
'use strict';var _interopRequireDefault=$$$AWF$$$.es6._interopRequireDefault;var _classCallCheck=$$$AWF$$$.es6._classCallCheck;var _possibleConstructorReturn=$$$AWF$$$.es6._possibleConstructorReturn;var _inherits=$$$AWF$$$.es6._inherits;var _Model=require('GroceryList/ListItem/Model');var _Model2=_interopRequireDefault(_Model);var _EventEmitter2=require('EventEmitter');var _EventEmitter3=_interopRequireDefault(_EventEmitter2);function _typeof(obj){return obj && typeof Symbol !== "undefined" && obj['constructor'] === Symbol?"symbol":typeof obj;}var Model=(function(_EventEmitter){_inherits(Model,_EventEmitter);function Model(){_classCallCheck(this,Model);var _this=_possibleConstructorReturn(this,_EventEmitter.call(this));_this.list = [];if(localStorage.GroceryList){var list=JSON.parse(localStorage.GroceryList);var _iter2=list;if(_iter2 && 'object' === (typeof _iter2 === 'undefined'?'undefined':_typeof(_iter2))){var _iter3=Array.isArray(_iter2)?0:Object.keys(_iter2),_iter=0,_iter4=_iter3?_iter3.length:_iter2.length;for(;_iter < _iter4;++_iter) {var item=_iter3?_iter2[_iter3[_iter]]:_iter2[_iter];item = new _Model2['default'](_this,item.text,item.crossed);_this.list.push(item);}}}_this.on('update',_this.saveOnUpdate);return _this;}Model.prototype.addItem = (function(){function addItem(text){if(!text)return;var item=new _Model2['default'](this,text);this.list.push(item);this.emit('update');return item;}return addItem;})();Model.prototype.removeItem = (function(){function removeItem(item){for(var i=0;i < this.list.length;i++) {if(this.list[i] == item){this.list.splice(i,1);this.emit('update');break;}}}return removeItem;})();Model.prototype.saveOnUpdate = (function(){function saveOnUpdate(){localStorage.setItem("GroceryList",JSON.stringify(this.list));}return saveOnUpdate;})();return Model;})(_EventEmitter3['default']);exports['default'] = Model;module.exports = Model;
});
$$$AWF$$$.define("GroceryList/Style", function(module, exports, require) {
module.exports="AQW-CtcqlA-Style";
});
$$$AWF$$$.define("GroceryList/View", function(module, exports, require) {
'use strict';var _interopRequireDefault=$$$AWF$$$.es6._interopRequireDefault;var _newArrowCheck=$$$AWF$$$.es6._newArrowCheck;var _classCallCheck=$$$AWF$$$.es6._classCallCheck;var _possibleConstructorReturn=$$$AWF$$$.es6._possibleConstructorReturn;var _inherits=$$$AWF$$$.es6._inherits;exports.__esModule = true;var _UIComponent2=require('UIComponent');var _UIComponent3=_interopRequireDefault(_UIComponent2);var _Style=require('GroceryList/Style');var _Style2=_interopRequireDefault(_Style);var _ListItem=require('GroceryList/ListItem');var _ListItem2=_interopRequireDefault(_ListItem);var ViewJSX=(function(_UIComponent){_inherits(ViewJSX,_UIComponent);function ViewJSX(){_classCallCheck(this,ViewJSX);return _possibleConstructorReturn(this,_UIComponent.apply(this,arguments));}ViewJSX.prototype.render = (function(){function render(){var _this2=this;return React.createElement('div',{className:_Style2['default']},React.createElement('div',{className:'title'},'Grocery List'),React.createElement('div',{className:'list'},this.model.list.map((function(item){_newArrowCheck(this,_this2);return React.createElement(_ListItem2['default'],{key:$$$AWF$$$.es6._boundProp(item,item.id),model:item});}).bind(this))),React.createElement('div',{className:'control'},React.createElement('input',{type:'text',onChange:this.bindState('input'),value:$$$AWF$$$.es6._boundProp(this.state,this.state.input)}),React.createElement('button',{onClick:$$$AWF$$$.es6._boundProp(this,this.addItem)},'Add')));}return render;})();return ViewJSX;})(_UIComponent3['default']);exports['default'] = ViewJSX;
});
$$$AWF$$$.define("GroceryList/Component", function(module, exports, require) {
'use strict';var _interopRequireDefault=$$$AWF$$$.es6._interopRequireDefault;var _classCallCheck=$$$AWF$$$.es6._classCallCheck;var _possibleConstructorReturn=$$$AWF$$$.es6._possibleConstructorReturn;var _inherits=$$$AWF$$$.es6._inherits;var _View2=require('GroceryList/View');var _View3=_interopRequireDefault(_View2);var _Model=require('GroceryList/Model');var _Model2=_interopRequireDefault(_Model);var Component=(function(_View){_inherits(Component,_View);function Component(){_classCallCheck(this,Component);return _possibleConstructorReturn(this,_View.apply(this,arguments));}Component.prototype.componentWillMount = (function(){function componentWillMount(){this.model = new _Model2['default']();this.follow(this.model);}return componentWillMount;})();Component.prototype.addItem = (function(){function addItem(){this.model.addItem(this.state.input);this.setState({input:''});}return addItem;})();return Component;})(_View3['default']);exports['default'] = Component;module.exports = Component;
});
$$$AWF$$$.define("GroceryList", function(module, exports, require) {
'use strict';var _interopRequireDefault=$$$AWF$$$.es6._interopRequireDefault;exports.__esModule = true;var _Component=require('GroceryList/Component');var _Component2=_interopRequireDefault(_Component);exports['default'] = _Component2['default'];
});
$$$AWF$$$.define("main", function(module, exports, require) {
'use strict';var _interopRequireDefault=$$$AWF$$$.es6._interopRequireDefault;var _GroceryList=require('GroceryList');var _GroceryList2=_interopRequireDefault(_GroceryList);ReactDOM.render(React.createElement(_GroceryList2['default'],null),document.body);
});
})();
